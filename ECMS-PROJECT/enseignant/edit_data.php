<?php
    ...
    if (isset($_POST['avancement'])){
      ...
      $sql =  "UPDATE tbl_data SET data_avncm_glob = '$avancement', data_nbr_chap = '$nbr_chap', data_nbr_cours = '$nbr_seances', data_nbr_tdtp = '$nbr_seances_tdtp' ,data_nbr_crtdtp = '$nbr_ceances_ctdtp_no' ,data_exps_micro = '$exps_micro',data_valid_tp = '$valid_tp',data_polycp_cour = '$Polycopie_cours',avis_ens = '$avis_ens' WHERE data_id='$dataid1'";
      $result = mysqli_query($con,$sql) or die ("La connexion a échoué: 2" . mysqli_error($con));


      // edit avec id responsable
      $sql =  "UPDATE tbl_data SET data_avncm_glob = '$avancement', data_nbr_chap = '$nbr_chap', data_nbr_cours = '$nbr_seances', data_nbr_tdtp = '$nbr_seances_tdtp' ,data_nbr_crtdtp = '$nbr_ceances_ctdtp_no' ,data_exps_micro = '$exps_micro',data_valid_tp = '$valid_tp',data_polycp_cour = '$Polycopie_cours',avis_ens = '$avis_ens'  WHERE data_id='$dataid2'";
      $result = mysqli_query($con,$sql) or die ("La connexion a échoué: 2" . mysqli_error($con));
