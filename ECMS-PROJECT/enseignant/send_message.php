...
<div class="main ">
  ...
  <div class="container">
    <?php
    $useridme = $_SESSION['enseignant_user_id'];
      ...
      <div class="inbox_msg">
        <div class="mesgs" style="margin:0;padding: 0;padding-top:10px;background-color:rgba(0, 0, 0, 0.08);width:100%">
          ...
          <div class="" style="padding:10px">
            <a href="messagerie.php"><i class="fa fa-chevron-left" style="font-size:250%;font-weight:20px;cursor:pointer;margin-right:10px;"></i></a>
            <i class="fa fa-user-circle-o" style="font-size:250%"> <?php echo $rowuserdata['user_name']; ?></i>
            <?php
            ...
            if ($countresultMessages > 0) {
              ...
              if ($rowresultMessages['msg_from_id'] == $useridme) {
                ...
                <div class="outgoing_msg">
                  <div class="sent_msg">
                    <p><strong>Sujet: <?php echo $rowresultMessages['msg_subject']; ?></strong> </p>
                    ...
                    <?php
                     ...
                     ?>
                    <span class="time_date"><?php echo date('h:ia \| d F Y', $srttime); ?></span>
                  </div>
                </div>
                ...
                <div class="incoming_msg">
                  ...
                  <div class="received_msg">
                    <div class="received_withd_msg">
                      <p><strong>Sujet: <?php echo $rowresultMessages['msg_subject']; ?></strong> Bonjour</p>
          ...
          <div class="type_msg">
            <div class="input_msg_write">
              <button id="send_message" class="msg_send_btn" style="width:100%"><i class="fa fa-paper-plane" aria-hidden="true"></i></button>
            </div>
          </div>
