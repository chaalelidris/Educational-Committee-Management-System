              ...
              <div class="chat_list">
                ...
                <div class="chat_people">
                  ...
                  <div class="chat_ib">
                    <?php
                    $user = $row['user_id'];
                    $sql = "SELECT msg_datetime,msg_status FROM tbl_messagerie where msg_from_id = '$ensid' AND msg_to_id = '$user' OR msg_to_id = '$ensid' AND msg_from_id = '$user' order by msg_datetime desc limit 1";
