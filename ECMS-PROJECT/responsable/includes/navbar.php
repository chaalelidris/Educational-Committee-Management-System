<div class="top">
  <div class="bar theme-l2 left-align large">
    <a class="bar-item button left hide-large hover-white large theme-primary" href="javascript:void(0)"
      onclick="w3_open()"><i class="fa fa-bars"></i></a>
    <a href="responsable.php" class="bar-item button theme-primary"><i class="fa fa-home margin-right"></i> GCP |
      RESPONSABLE</a>
    <a href="#" id="disscon" class="bar-item button right hover-white"><i class="fa fa-sign-out"></i></a>


    <div class="dropdown-hover right">
      <a href="responsable.php" class="button primary" title="">
        <?php echo  $_SESSION['responsable_user_name'];?></i>
      </a>
