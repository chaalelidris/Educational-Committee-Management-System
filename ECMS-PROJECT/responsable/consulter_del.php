...
<div class="main">
  ...
  <div class="container">
    ...
    $cptitle = $rowcptitle['cp_title'];
     ?>
    <h2><?=$translations['consult']?> CP <span style="color:rgba(56, 148, 255, 1)">( <?php echo $cptitle; ?> )</span></h2>
    ...
    <div class="cell-row">
      <div class="container cell">
        <p><button id="Arrier_cps"class="button green hover-green round-large"> <i class="	fa fa-chevron-left"></i> <?=$translations['back']?></button></p>
      </div>
      <div class="container  cell">
      </div>
    </div>
          ...
          <?php
            if ($countdata > 0) {
              ...
              <form class="" action="get_submitted_data.php" method="post">
                ...
                <!-- <button name="btn_to_edit_data"class="button green  right " onclick="Load()" style="margin-top:18px;">Modifier les donnés <i class="fa fa-pencil"></i> </button> -->
              </form>
              <?php
            }else {
              ?>
