...
<?php if (isset($_SESSION['switch_fmdcp'])): ?>
  ...
  <ul class="breadcrumb" >
    ...
    <li>Modifier CP <?php echo $_SESSION['responsable_prom_name']; ?></li>
  </ul>
  <hr class="rounded">
  ...
  <div class="container">
    ...
    <div class="cell-row">
      <div class="container cell">
        <p><button id="modifier_cp" class="button green hover-green"> <i class="	fa fa-chevron-left"></i> Arrière</button></p>
      </div>
      <div class="container  cell">
      </div>
    </div>
    ...
    <div class="container_actcp">
      <form action="edit_cp.php" method="post">
        ...
        <div class="row">
          ...
          <div class="col-75">
            <input value="<?php echo $_SESSION['edit_titre']; ?>" class="input_form_actcp" type="text" name="titre" placeholder="Le titre..">
          </div>
        </div>
        ...
        <div class="row" style="margin-bottom:16px;">
          ...
          <div class="col-75">
            <?php
             ...
             ?>
            <input type="datetime" value="<?php echo date('Y/m/d h:ia', $srttime); ?>" class="input_form_actcp"  name="datetime" placeholder="La date et l'heure..">
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-75">
            <input value="<?php echo $_SESSION['edit_location']; ?>" class="input_form_actcp" type="text" name="lieu" placeholder="Le lieu..">
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-75">
            <select class="select border" name="semestre" title="veuillez sélectionner" style="background-color:#f1f1f1; padding:15px 10px;" required>
              <option value="<?php echo $_SESSION['edit_semestre']; ?>" selected><?php echo "semestre N°".$_SESSION['edit_semestre_name']  ?></option>
  ...
  N’ayant aucun autre point à l’ordre du jour, la séance fut levée à 13H00." style="height:200px"><?php echo $_SESSION['edit_intervension']; ?></textarea>
          </div>
        </div>
