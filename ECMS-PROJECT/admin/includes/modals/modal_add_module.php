  ...
  <?php else: ?>
    ...
    <form class="modal-content animate-zoom" action="add_module.php" method="post">
      <div class="container-form">
        ...
        <h1 style="color:#191923;"><?=$translations['add_module']?></h1>
        ...
        <label for="semestre"><b><?=$translations['semester']?></b></label>
        ...
        <label for="ensid"><b><?=$translations['select_mod_teach']?></b></label><br>
