      ...
      <div class="inbox_msg">
        <div class="inbox_people" style="width:100%">
          ...
          <div class="inbox_chat" id="myContacts">
            ...
            <?php
            $adminid = $_SESSION['super_admin_user_id'];
            $sql = "SELECT * 
                    FROM tbl_users 
              ...
              <div class="chat_people">
                ...
                <div class="chat_ib">
                  ...
                  <h5>
                    ...
                    <?php if (!empty($row_result_msg_from_to) && $row_result_msg_from_to['msg_to_id'] == $myid && $row_result_msg_from_to['msg_status'] == 1) :?>
                    <span class="tag red round left">Nouveau message de </span>
                    <?php endif; ?>

                    &nbsp
                    
                    <?= $row['user_name'] ?>
                    <?php if ($rowResultMsgDate = mysqli_fetch_array($resultMsgDate)): ?>
                    <span class="chat_date"><?= $rowResultMsgDate['msg_datetime'] ?></span>
                    <?php endif; ?>
                  </h5>
                  ...
                  <?php if($row['user_type'] == 'admin'): 
                    ...
                    $sql = "SELECT department_name FROM tbl_department WHERE admin_id='$userid'";
                    $result_department_name = mysqli_query($con, $sql);
                    $row_department_name = mysqli_fetch_array($result_department_name);
                    ?>
                    
                    <p><?=$translations['admin']?> : <?php echo $row_department_name['department_name']; ?></p>
                  <?php endif; ?>
                </div>
              </div>
            </div>
